...
**Tests**: Include automated test tasks for every executable behavior change. An exception MUST
be documented in plan.md with the reason automation is not feasible.
...
- [ ] TXXX Prepare pull request with required artifact links, CI evidence, and changeset status
...
- Tests for executable behavior changes MUST be written and FAIL before implementation
